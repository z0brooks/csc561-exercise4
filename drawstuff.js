...
function main() {
    ...
    var poly2 = [{x:-5,y:5,z:10,c:new Color(255,0,0,255)}, {x:5,y:5,z:8,c:new Color(0,255,0,255)}, 
                {x:5,y:-5,z:8,c:new Color(0,0,0,255)}, {x:-5,y:-5,z:10,c:new Color(0,0,255,255)}];
