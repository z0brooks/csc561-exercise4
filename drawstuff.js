...
function main() {
    ...
    var poly2 = [{x:5,y:12,z:5,c:new Color(0,0,0,255)}, 
                {x:8,y:9,z:5,c:new Color(0,255,0,255)},
                {x:5,y:6,z:10,c:new Color(255,0,0,255)}, 
                {x:2,y:9,z:10,c:new Color(0,0,255,255)}];
